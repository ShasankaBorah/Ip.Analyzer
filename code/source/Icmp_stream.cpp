...
//if (newVector.size() == 1)
//{
//	int k; //for new vector
//	auto i = newVector.at(0);

//	if (i.request == true)
//	{
//		k = 8;
//	}
//	else if (i.reply == true)
//	{
//		k = 0;
//	}
//	else if(i.destUnreachable == true)
//	{
//		k = 3;
//	}
//	else if(i.ttlExceeded == true)
//	{
//		k = 11;
//	}

	//if(request_type_received == 8 && k == 8) //that means same type of pcaket recieved with same sequence number so add it to the icmp_stream_vector
	//{
	//		//request
	//	item.request = true;
	//	icmp_stream_vector.push_back(item);

	//}
	//else if(request_type_received == 0 && k == 0)
	//{
	//	//reply
	//	item.reply = true;
	//	icmp_stream_vector.push_back(item);
	//}
	//else if(request_type_received == 3 && k == 3)
	//{
	//	//destination unreachable
	//	item.destUnreachable = true;
	//	icmp_stream_vector.push_back(item);
	//}
	//else if(request_type_received == 11 && k == 11)
	//{
	//	//ttl exceeded
	//	item.ttlExceeded = true;
	//	icmp_stream_vector.push_back(item);
	//}
	//else if(request_type_received == 8 && k == 0)
	//{
	//	std::cout << "hello" << std::endl;
	//}
...
//		break;
//	case 3: //dst unreachable
//		i.destUnreachable = true;
//		i.unreachableTimeStamp = ts;
//		break;
//	case 11: //ttl exceeded
//		i.ttlExceeded = true;
//		i.ttlExcessTimeStamp = ts;
//		break;
//	default:
//		i.unsupported_type = true;
//		break;
//	}
//}
